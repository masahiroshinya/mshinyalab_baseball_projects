...
> 詳細 → [understanding_map.md](./understanding_map.md)　｜　❓の番号をAIに伝えると解説してもらえる
...
**今週の優先学習**：`1-5` 歪み係数k1の意味　／　`3-2` 斉次座標とW除算　／　`5-2` reshapeの理由

> 理解が進んだら [understanding_map.md](./understanding_map.md) の該当行を `❓→🟡→✅` に書き換える
...
- [ ] **【AI向け明日の初回タスク】**: 明日のセッション開始時に、ユーザーに対して以下のQiita記事（ステレオキャリブレーション等に関する記事）について、「どのようなものか」をURLとともに尋ねること。URL: https://qiita.com/syunnsyunn74/items/155ee816f39691f021d2 `[作成者: AI]` `[追加日: 2026-05-14]`
